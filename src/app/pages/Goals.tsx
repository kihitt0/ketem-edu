    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[#1a1a1a] via-[#2C2C2C] to-[#1a1a1a] text-white py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            Пошаговая программа поступления в европейские университеты
          </motion.p>
        </div>
      </section>
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                description: 'Комплексная помощь со всеми этапами под ключ — от билетов и жилья до встречи в аэропорту и адаптации на месте.',
                duration: '2-4 недели',
                tasks: [
