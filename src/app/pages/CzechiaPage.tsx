...
export const CzechiaPage: React.FC = () => {
  ...
  const universities = [
    ...
    { name: 'Горно-геологический университет в Остраве (VŠB)', city: 'Острава', tuition: 'Бесплатно на чешском / €2,500–5,500 на английском', programs: ['Инженерия', 'IT', 'Экономика'], ranking: '#6 в Чехии', rank: 6, lang: 'both', image: 'https://www.vsb.cz/export/sites/vsb/.galleries/image-gallery/vsb-budova.jpg' },
    { name: 'Университет химической технологии Праги', city: 'Прага', tuition: 'Бесплатно на чешском / €3,000–6,000 на английском', programs: ['Химия', 'Биотехнологии', 'Инженерия'], ranking: '#7 в Чехии', rank: 7, lang: 'both', image: 'https://vscht.cz/files/uzel/0016898/ucft_2.jpg' },
    { name: 'Пражский университет экономики и бизнеса', city: 'Прага', tuition: 'Бесплатно на чешском / €3,500–6,500 на английском', programs: ['Бизнес', 'Экономика', 'Финансы', 'Менеджмент'], ranking: '#8 в Чехии', rank: 8, lang: 'both', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/VŠE_Praha.jpg/1200px-VŠE_Praha.jpg' },
  ];
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <p className="text-xl mb-8 text-gray-700">Получите бесплатное образование в самом сердце Европы!</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/login" className="bg-orange-500 text-white px-8 py-4 rounded-xl font-bold hover:bg-orange-600 transition-all shadow-lg">Получить консультацию</Link>
              <Link to="/about" className="bg-gray-900 text-white px-8 py-4 rounded-xl font-bold hover:bg-gray-800 transition-all">Узнать больше</Link>
            </div>
          </motion.div>
        </div>
      </section>
